...
{
    public partial class UChemsire : UserControl
    {
        public UChemsire()
        {
            InitializeComponent();
        ...
        private void UChemsire_Load(object sender, EventArgs e)
        {
            hastalarYazdir();
        ...
        {
            string sorgu = "SELECT * FROM hemsireler_yazdir()";
        ...
        private void ekle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand command1 = new NpgsqlCommand("CALL hemsire_ekle(@ad, @soyad, @dogum::DATE, @cinsiyet::CHAR(5)," +
                " @ise_tarihi_alma::DATE, @unvan, @bolum, @tel::CHAR(11), @adres, @epsta)", veriTabini.baglanti);
            ...
            command1.Parameters.AddWithValue("@bolum", int.Parse(bolum.Text));
            ...
            try
            {
                ...
                MessageBox.Show("Bir hemşire eklendi");
            }
            catch (Exception ex)
            {
        ...
        private void duzenle_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand command1 = new NpgsqlCommand("CALL hemsire_guncelleme(@id, @ad, @soyad, @dogum::DATE, @cinsiyet::CHAR(5)," +
                " @ise_tarihi_alma::DATE, @unvan, @bolum, @tel::CHAR(11), @adres, @epsta)", veriTabini.baglanti);
            command1.Parameters.AddWithValue("@id", int.Parse(id.Text));
            command1.Parameters.AddWithValue("@ad", adi.Text);
            command1.Parameters.AddWithValue("@soyad", soyadi.Text);
            ...
            {
                command1.ExecuteNonQuery();
                MessageBox.Show("Bir hemşire düzenlendi");
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Hata: {ex.Message}");
        ...
        private void ara_Click(object sender, EventArgs e)
        {
            ...
            NpgsqlCommand command1 = new NpgsqlCommand("SELECT * FROM hemsire_arama(@id, @ad)", veriTabini.baglanti);
